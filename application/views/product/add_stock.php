        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="column">
                    ...
                    <a href="<?php echo base_url('Cproduct/add_stock') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> New Stock </a>
            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="add_item" class="col-sm-4 col-form-label">Product Code <i class="text-danger">*</i></label>
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="text" name="product_code" class="form-control" placeholder='product code' id="product_code" autocomplete='off' tabindex="1">
                        ...
                        <?php echo form_open_multipart('Cproduct/add_stock_data', array('class' => 'form-vertical', 'id' => '', 'name' => 'insert_pos_invoice')) ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8" id="payment_from_1">
                                ...
                                <div class="form-group row">
                                   ...
                                   <!--  <label for="customer_name1" class="col-sm-3 col-form-label">Quantity <i class="text-danger">*</i></label> -->
...
<script type="text/javascript">
    ...
    window.onload = function () {
        ...
        var text_input = document.getElementById('product_code');
    ...
    $('#product_code').keydown(function (e) {
        ...
        if (e.keyCode == 13) {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url('Cproduct/insert_stock') ?>',
