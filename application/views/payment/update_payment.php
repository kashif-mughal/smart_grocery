...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <h1>Update Transection</h1>

            <small>Update Transection</small>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Update Transection</li>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Cpayment/manage_payment')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> Manage Transection</a>
                        ...
                        <div id="bank_info_hide">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="test" id="cheque_or_pay_order_no" class="form-control"  name="cheque_no" placeholder="<?php echo display('cheque_or_pay_order_no') ?>" value="{cheque_no}" />
...
<input class="none form-control " name ="pay_amount" id="school" class="none" type="number" placeholder="Payment Amount" value="{pay_amount}" ></div>
...
<input class="none form-control " name ="amount" id="school" class="none" type="number" placeholder="Recipt Amount" value="{amount}"></div>
