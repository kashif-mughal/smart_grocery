                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class='form-control' name="employee" id="employee" tabindex="5">
                                    {employee_list}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class='form-control' name="route" id="route" tabindex="6">
                                    <?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="credit_limit" id="credit_limit" type="number" placeholder="<?php echo display('credit_limit') ?>" tabindex="7">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" type="number" min=0 max=100 name="discount" id="discount"  placeholder="<?php echo display('discount') ?>" tabindex="8">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="area" id="area" type="text" placeholder="<?php echo display('area') ?>" tabindex="9">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="previous_balance" id="previous_balance" type="text" placeholder="<?php echo display('previous_balance') ?>" tabindex="10">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" id="add-customer" class="btn btn-primary btn-large" name="add-customer" value="<?php echo display('save') ?>" tabindex="11"/>
                                <input type="submit" value="<?php echo display('save_and_add_another') ?>" name="add-customer-another" class="btn btn-large btn-success" id="add-customer-another" tabindex="12">
                            </div>
                        </div>
                    </div>
                    <?php echo form_close() ?>
