        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open('Ccategory/insert_category', array('class' => 'form-vertical', 'enctype' => 'multipart/form-data', 'id' => 'insert_category')) ?>
                    <div class="panel-body">

                        <div class="form-group row">
                            <label for="CatName" class="col-sm-3 col-form-label">Category Name <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="CatName" id="CatName" type="text" placeholder="Category Name"  required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="Alias" id="Alias" type="text" placeholder="Alias">
                            </div>
                        </div>
