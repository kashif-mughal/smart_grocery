										...
										<td>
											...
											<center>
												...
												<?php echo form_open()?>
													...
													<a href="<?php echo base_url().'Cinvoice/delivery_challan/{invoice_id}'; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('invoice') ?>"><i class="fa fa-window-restore" aria-hidden="true"></i></a>
