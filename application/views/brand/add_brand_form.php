        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open('Cbrand/insert_brand', array('class' => 'form-vertical', 'enctype' => 'multipart/form-data', 'id' => 'insert_brand')) ?>
                    <div class="panel-body">

                        <div class="form-group row">
                            <label for="BrandName" class="col-sm-3 col-form-label">Brand Name <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="BrandName" id="BrandName" type="text" placeholder="brand Name"  required="">
                            </div>
                        </div>
