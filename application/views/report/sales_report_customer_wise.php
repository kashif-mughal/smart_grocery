	...
	<section class="content-header">
		...
		<div class="header-title">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Sales Report (Customer Wise)</li>
			</ol>
		</div>
	</section>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body"> 
						<?php echo form_open('Admin_dashboard/date_to_date_customer_wise_report',array('class' => 'form-inline','method' => 'get'))?>
				...
				<div class="panel panel-bd lobidrag">
					<div class="panel-heading">
						...
						<span class="text-right">
							<?php echo form_open('Admin_dashboard/sales_report_customer_wise_search_by_user_name',array('class' => 'form-inline','method' => 'get'))?>
								...
								<tbody>
									...
									if ($invoices_list) {
										...
										<tr>
											...
											<td></td>
											<td style="text-align: right;"><?php echo (($position==0)?"$currency {total_amount_by_customer}":"{total_amount_by_customer} $currency") ?>
											</td>
											<td style="text-align: right;"><?php echo (($position==0)?"$currency {sale_return}":"{sale_return} $currency") ?>
											</td>
											<td style="text-align: right;"><?php echo (($position==0)?"$currency {net_sales}":"{net_sales} $currency") ?>
											</td>
											<td></td>
											<td></td>
											<td></td>
