                        ...
                        <tbody id="addinvoiceItem">
                            ...
                            <tr>
                                <td class="" style="width: 200px;">
                                    ...
                                    <input type="hidden" class="product_uuid_{sl} autocomplete_hidden_value"  value="{product_uuid}" id="product_uuid_{sl}"/>
                                </td>
                                <td>
                                    <input type="text" id="sold_qty_{sl}" class="form-control text-right available_quantity_1" value="{quantity}" readonly="" />
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" value="{rate}" id="price_item_original_{sl}"/>
                                </td>
                                ...
                                <td>
                                    ...
                                    <input id="all_tax_{sl}" class="total_tax" type="hidden" value="0">
                                    <!-- Tax calculate end-->
...
<script type="text/javascript">
    function checkboxcheck(sl){
        ...
        var product_uuid  ='product_uuid_'+sl;
        var total_price  ='total_price_'+sl;
        var discount  ='discount_'+sl;
        var product_rate  ='price_item_original_'+sl;
        var tax  ='all_tax_'+sl;
        ...
        if($('#'+check_id).prop("checked") == true){
            ...
            document.getElementById(product_uuid).setAttribute("name","product_uuid[]");
            document.getElementById(product_rate).setAttribute("name","product_rate_original[]");
            document.getElementById(tax).setAttribute("name","tax[]");
            ...
            document.getElementById(product_uuid).removeAttribute("name","");
            document.getElementById(product_rate).removeAttribute("name","");
            document.getElementById(tax).removeAttribute("name","");
