        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open('Cunit/insert_unit', array('class' => 'form-vertical', 'enctype' => 'multipart/form-data', 'id' => 'insert_unit')) ?>
                    <div class="panel-body">

                        <div class="form-group row">
                            <label for="UnitName" class="col-sm-3 col-form-label">Unit Name <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="UnitName" id="UnitName" type="text" placeholder="unit Name"  required="">
                            </div>
                        </div>
