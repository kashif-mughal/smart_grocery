                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="text" tabindex="2" class="form-control datepicker" name="due_date" value="{due_date}" id="due_date" required />
                                ...
                                <tbody id="addPurchaseItem">
                                    ...
                                    <tr>
                                        ...
                                        <td class="span3 supplier">
                                           ...
                                           <input type="text" name="po_product_name" required class="form-control product_name productSelection" onkeypress="product_pur_or_list({sl});" placeholder="<?php echo display('product_name') ?>" id="po_product_name_{sl}" tabindex="5" value="{product_name}"  >



                                            <input type="hidden" class="autocomplete_hidden_value product_id_{sl}" name="po_product_id[]" id="SchoolHiddenId" value="{product_id}"/>
                                       ...
                                       <td class="wt">
                                            ...
                                            <td class="text-right">
                                                ...
                                                <input type="text" name="po_product_quantity[]" id="cartoon_{sl}" class="form-control text-right store_cal_{sl}" onkeyup="calculate_store({sl});" onchange="calculate_store({sl});" placeholder="0.00" value="{po_quantity}" min="0" tabindex="6"/>

                                            </td>

                                            <td class="test">

                                                <input type="text" name="po_product_rate[]" onkeyup="calculate_store({sl});" onchange="calculate_store({sl});" id="product_rate_{sl}" class="form-control po_product_rate_{sl} text-right" placeholder="0.00" value="{po_rate}" min="0" tabindex="7"/>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <input class="form-control po_total_price text-right" type="text" name="po_total_price[]" id="po_total_price_{sl}" value="{po_total_amount}" readonly="readonly" />
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <input type="text" id="po_grandTotal" class="text-right form-control" name="po_grand_total_price" value="{po_total}" readonly="readonly" />
