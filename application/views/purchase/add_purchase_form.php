                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cpurchase/insert_purchase',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <?php $date = date('Y-m-d'); ?>
                                        <input type="text" tabindex="2" class="form-control datepicker" name="due_date" value="<?php echo $date; ?>" id="due_date" required />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="rcv_po" class="col-sm-12 col-form-label"><input type='checkbox' tabindex="4" id="rcv_po" name="rcv_po" value="rcv_po" /> <?php echo "Recieved Puchase Order" ?>
                                    </label>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="adress" class="col-sm-3 col-form-label"><?php echo display('details') ?>
                                    </label>
                                    <div class="col-sm-8">
