                            ...
                            <table id="dataTableExample-supplier" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <center>
                                        ...
                                        <a href="" class="deleteSupplier btn btn-danger btn-sm" name="{supplier_id}" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                         <a href="<?php echo base_url() . 'Csupplier/supplier_detail_ledger/{supplier_id}'; ?>" class="supplierDetailLedger btn btn-success btn-sm" name="{supplier_id}" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('detail') ?> "><i class="fa fa-user-o" aria-hidden="true"></i></a>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        for($i=0;$i<count($suppliers_list);$i++){

                                            $sum += $suppliers_list[$i]['supplier_balance'];
                                        }
                                            echo $sum;
                                            ?></td>
                                        <td></td>
